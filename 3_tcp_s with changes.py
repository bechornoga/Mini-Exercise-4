...
# Change: I changed the maximum number of queued connections to be 8 instead of 5,
# which means that the server will only be able to queue up to 8 incoming TCP connections from
# clients before it starts rejecting new connections.
server.listen(8)
